...
**Ví dụ: HRIS** (đồ án giảng viên demo)
...
| API requests | Không giới hạn số lượng tổng (có [rate limit](https://supabase.com/docs/guides/platform/going-into-prod#rate-limiting)) |
| Bandwidth    | 5 GB                                                                                                                    |

→ **Dư sức** cho đồ án cuối khoá với 5–20 user nội bộ. Chi tiết xem [Supabase Pricing](https://supabase.com/pricing).

---

## 8. Tất Cả Gộp Lại — Luồng Đi Cụ Thể

Ví dụ: **HR manager xem hồ sơ nhân viên trên HRIS**
...
*📖 Quay lại: [02 — Git & GitHub Cơ Bản](./02-git-basics.md)*  
