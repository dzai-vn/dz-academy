---
title: "Primer Pack — Mục Lục & Tiến Độ"
description: Tài liệu nền bắt buộc đọc TRƯỚC buổi 1 khoá Vibe Coding Thực Chiến Cùng BMAD
page-layout: full
author: Duy NHM
created: 2026-05-12
toc: true
...
Đánh dấu ✅ mỗi bài khi hoàn thành. Tổng thời gian đọc: **~5 giờ 15 phút**.
...
| 08 | [Hướng Dẫn Học Online](./08-online-class-guide.md) | 15' | ☐ |
...
```mermaid
graph LR
    A["01<br/>Code<br/>30'"] --> B["02<br/>Git<br/>45'"]
    B --> C["03<br/>FE/BE/DB<br/>45'"]
    C --> D["04<br/>Agile<br/>30'"]
    D --> E["05<br/>AI Agent<br/>30'"]
    E --> F["06<br/>BMAD<br/>45'"]
    F --> G["07<br/>Setup<br/>60'"]
    G --> H["08<br/>Online<br/>15'"]
```
...
- **Vướng nội dung Primer Pack:** Đăng lên Discord kênh `#warmup-help`
- **Vướng cài đặt công cụ:** Đăng lên Discord kênh `#bmad-troubleshoot` kèm screenshot lỗi
- **Câu hỏi chung:** Nhắn trực tiếp mentor trên Discord
